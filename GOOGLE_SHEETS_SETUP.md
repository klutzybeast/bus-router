...
4. The API URL is already configured: `https://camper-routes-1.preview.emergentagent.com/api/sheets/compact-availability`
...
`https://camper-routes-1.preview.emergentagent.com/api/sheets/compact-availability`
