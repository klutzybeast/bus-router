...
4. The API URL is already configured: `https://routewise-camp.preview.emergentagent.com/api/sheets/compact-availability`
...
`https://routewise-camp.preview.emergentagent.com/api/sheets/compact-availability`
