...
4. The API URL is already configured: `https://campbus.preview.emergentagent.com/api/sheets/compact-availability`
...
`https://campbus.preview.emergentagent.com/api/sheets/compact-availability`
