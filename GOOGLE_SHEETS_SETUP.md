...
4. The API URL is already configured: `https://camper-location.preview.emergentagent.com/api/sheets/compact-availability`
...
`https://camper-location.preview.emergentagent.com/api/sheets/compact-availability`
