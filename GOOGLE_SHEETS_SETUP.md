...
4. The API URL is already configured: `https://camp-bus-mapper.preview.emergentagent.com/api/sheets/compact-availability`
...
`https://camp-bus-mapper.preview.emergentagent.com/api/sheets/compact-availability`
