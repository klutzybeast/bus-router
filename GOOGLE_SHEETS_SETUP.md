...
4. The API URL is already configured: `https://counselor-scroll-fix.preview.emergentagent.com/api/sheets/compact-availability`
...
`https://counselor-scroll-fix.preview.emergentagent.com/api/sheets/compact-availability`
