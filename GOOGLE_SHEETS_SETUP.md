...
4. The API URL is already configured: `https://busroute-mapper-1.preview.emergentagent.com/api/sheets/compact-availability`
...
`https://busroute-mapper-1.preview.emergentagent.com/api/sheets/compact-availability`
