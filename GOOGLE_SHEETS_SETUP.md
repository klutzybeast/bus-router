...
4. The API URL is already configured: `https://counselor-admin-test.preview.emergentagent.com/api/sheets/compact-availability`
...
`https://counselor-admin-test.preview.emergentagent.com/api/sheets/compact-availability`
